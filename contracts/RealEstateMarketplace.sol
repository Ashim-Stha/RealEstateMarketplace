...
contract RealEstateMarketplace {
    ...
    event AssestBought(address indexed buyer,address indexed assestAddress,address indexed tokenId,uint256 price);
    ...
    function buyAssest(assestAddress, tokenId);(address assestAddress, uint256 tokenId) external payable isListed(assestAddress, tokenId) {
        ...
        emit ItemBought(msg.sender,assestAddress,tokenId, listedAssest.price);
    }
}
